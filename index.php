...
if (isset($_GET['p'])) {
    ...
    $pg = "pages/" . $pagina;
    if(!file_exists($pg)){
        $pagina = "inicial.php"; // caso minha url (page) Não existe vai ser redirecionado para inicial.php
    }
}
...
<body>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <span><?php echo strtoupper($dados_usuario['nome']); ?></span>
    ...
    <div class="fixed-button">
        <a href="https://github.com/Unordestino" target="_blank" class="btn btn-md btn-primary">
            <i class="fa fa-shopping-cart" aria-hidden="true"></i> Meu GitHub
        </a>
    </div>
