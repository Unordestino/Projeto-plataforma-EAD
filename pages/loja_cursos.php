...
if(!isset($_SESSION))
    ...
    if(isset($_POST['adquirir'])){
        ...
        // verifica se o usuario possui creditos para compra-lo
        ...
        if($preco_do_curso > $creditos_do_usuario){
            ...
            $valor = $creditos_do_usuario - $preco_do_curso;
            $mysqli->query("UPDATE usuarios set creditos = '$valor' WHERE id = '$id_user'") or die($mysqli->error);
...
<div class="page-body">
    ...
    <div class="col-sm-12">
            ...
            <?php if ($erro !== false) { //exibe erro na tela ?> 
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <form action="" method="post">                          
                            <button type="submit" name="adquirir" value="<?php echo $curso['id']; ?> " class="btn form-control btn-out-dashed btn-success btn-square">Adquirir 
                            Por R$ <?php echo number_format($curso['preco'], 2, ',', '.'); ?> </button>
                        </form>
                    </div>
                </div>
            </div>
