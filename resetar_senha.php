                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form method="POST" class="md-float-material">
                            <div class="text-center">
                                <img height="60px" src="assets/images/logo_preto.png" alt="logo_preto.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <p class="text-left" style="color: black;">Digite seu e-mail e a senha será enviada para ele.</p>
